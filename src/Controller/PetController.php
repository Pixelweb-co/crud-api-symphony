...
/**
 * Class PetController edwin guevara v1
...
class PetController
{
    ...
    public function add(Request $request): JsonResponse
    {
        ...
        $photoUrls = $request->query->get('photoUrls');
        $photoUrls = [];
    ...
    public function update($id, Request $request): JsonResponse
    {
		...
		return new JsonResponse(['status' => 'Mascota actuailza!'], Response::HTTP_OK);
    }
    ...
    public function delete($id): JsonResponse
    {
        ...
        return new JsonResponse(['status' => 'Mascota Eliminada'], Response::HTTP_OK);
    }
}
